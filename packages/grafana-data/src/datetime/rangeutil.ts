...
const hiddenRangeOptions = [
  { from: 'now', to: 'now+1m', display: 'Следующая минута', section: 3 },
  { from: 'now', to: 'now+5m', display: 'Следующие 5 минут', section: 3 },
  { from: 'now', to: 'now+15m', display: 'Следующие 15 минут', section: 3 },
  { from: 'now', to: 'now+30m', display: 'Следующие 30 минут', section: 3 },
  { from: 'now', to: 'now+1h', display: 'Следующий час', section: 3 },
  { from: 'now', to: 'now+3h', display: 'Следующие 3 часа', section: 3 },
  { from: 'now', to: 'now+6h', display: 'Следующие 6 часов', section: 3 },
  { from: 'now', to: 'now+12h', display: 'Следующие 12 часов', section: 3 },
  { from: 'now', to: 'now+24h', display: 'Следующие 24 часа', section: 3 },
  { from: 'now', to: 'now+2d', display: 'Следующие 2 дня', section: 0 },
  { from: 'now', to: 'now+7d', display: 'Следующие 7 дней', section: 0 },
  { from: 'now', to: 'now+30d', display: 'Следующие 30 дней', section: 0 },
  { from: 'now', to: 'now+90d', display: 'Следующие 90 дней', section: 0 },
  { from: 'now', to: 'now+6M', display: 'Следующий месяц', section: 0 },
  { from: 'now', to: 'now+1y', display: 'Следующие год', section: 0 },
  { from: 'now', to: 'now+2y', display: 'Следующие 2 года', section: 0 },
  { from: 'now', to: 'now+5y', display: 'Следующие 5 лет', section: 0 },
];
