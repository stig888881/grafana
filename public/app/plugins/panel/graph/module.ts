...
class GraphCtrl extends MetricsPanelCtrl {
  ...
  onInitEditMode() {
    this.addEditorTab('Параметры отображения', 'public/app/plugins/panel/graph/tab_display.html');
    this.addEditorTab('Оси', axesEditorComponent);
    this.addEditorTab('Обозначения', 'public/app/plugins/panel/graph/tab_legend.html');
  ...
  onInitPanelActions(actions) {
    actions.push({ text: 'Экспорт CSV', click: 'ctrl.exportCsv()' });
    actions.push({ text: 'Переключить обозначение', click: 'ctrl.toggleLegend()', shortcut: 'p l' });
  }
